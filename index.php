...
<html>
  <head>
    ...
    <!--link rel="stylesheet" href="header_nav_bar.css" type="text/css">
  ...
  <body>
    ...
    <div class = "medium">
      ...
      <text>Are you ready for an amazing online shopping experience? Check out FashionZilla, where you’ll find a great selection</text> <br> <text>at the most competitive prices.</text>
    </section>
    <section id = "products">
      How you doin'?
    </section>
